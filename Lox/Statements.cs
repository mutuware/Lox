...
namespace Lox
{
    public abstract record Stmt
    {
        ...
        public record Class(Token Name, Variable Superclass, List<Stmt.Function> Methods) : Stmt { public override T Accept<T>(IVisitor<T> visitor) => visitor.VisitClassStmt(this); }
